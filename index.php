                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="project-filter-wrapper">
                                    ...
                                    <div class="projects-grid projects-style-1 projects-col3">
                                        ...
                                        <div class="project-item ideas technology">
                                            <div class="projects-box">
                                                <div class="projects-thumbnail">
                                                    <a href="portfolio-details-3.html/index.html">
                                                        <img src="images/projects/720x720/project3-720x720.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="portfolio-info ">
                                                    <a class="overlay" href="portfolio-details-3.html/index.html"></a>
                                                    <div class="portfolio-info-inner">
                                                        <h5><a href="portfolio-details-3.html/index.html">Analysis of Security</a></h5>
                                                        <p class="portfolio-cates">
                                                            <a href="#">Ideas</a><span>/</span>
                                                            <a href="#">Technology</a>
                                                        </p> 
                                            ...
                                            <div class="projects-box">
                                                <div class="projects-thumbnail">
                                                    <a href="portfolio-details-3.html">
                                                        <img src="images/projects/720x720/project5-720x720.jpg" alt=""></a>
                                                </div>
                                                <div class="portfolio-info ">
                                ...
                                <div class="ot-button text-center">
                                    <a href="portfolio-grid.html" class="octf-btn octf-btn-primary">All Projects</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 mt--170">
                                <div class="cta">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-center text-md-right align-self-end">
                                ...
                                <div class="team-wrap v3">
                                    <div class="team-thumb">
                                        ...
                                        <div class="team-social flex-middle">
                                            <div>
                                                <a rel="nofollow" href="twitter.html" class="twitter"><i class="fab fa-twitter"></i></a>
                                                <a rel="nofollow" href="linkedin.html" class="linkedin"><i class="fab fa-linkedin-in"></i></a>
                                                <a rel="nofollow" href="pinterest.html" class="pinterest"><i class="fab fa-pinterest-p"></i></a>
                                                <a rel="nofollow" href="instagram.html" class="instagram"><i class="fab fa-instagram"></i></a>
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="team-info">
                                ...
                                <div class="team-wrap v3">
                                    <div class="team-thumb">
                                        ...
                                        <div class="team-social flex-middle">
                                            <div>
                                                <a rel="nofollow" href="twitter.html" class="twitter"><i class="fab fa-twitter"></i></a>
                                                <a rel="nofollow" href="linkedin-2.html" class="linkedin"><i class="fab fa-linkedin-in"></i></a>
                                                <a rel="nofollow" href="pinterest-2.html" class="pinterest"><i class="fab fa-pinterest-p"></i></a>
                                                <a rel="nofollow" href="instagram.html" class="instagram"><i class="fab fa-instagram"></i></a>
                                            </div>
                                        </div>  
                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                                <a class="tech-box text-center" href="index-3.html" target="_blank">
                                    <div class="icon-main"><span class="flaticon-code-1"></span></div>
                                    <h5>WEB</h5>
                                </a>
                            </div>
                            <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                                <a class="tech-box text-center" href="index-3.html">
...
<!-- <section class="bg-map-dots"> 
                ...
                <section class="contact-page">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <form action="http://templates.thememodern.com/engitech/contact.php" method="post" class="wpcf7">
                                    <div class="main-form">
    ...
    <!-- Mirrored from templates.thememodern.com/engitech/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Feb 2021 03:09:16 GMT -->
</html>